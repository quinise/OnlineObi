    ...
    return (
        ...
        <div className="card">
            ...
            <div className='mt-5 mb-10 flex items-center justify-center'>
                <button className='bg-blue-600/90 px-5 py-5' onClick={signInWithGoogle}><img className="object-cover h-10 w-10 mr-4 inline" src="src/assets/GoogleIcon.png"/><p className="text-white font-bold inline">Sign in with Google</p></button>
            </div>
            </>
            )}
        </div>
